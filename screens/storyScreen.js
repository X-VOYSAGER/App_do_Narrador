        ...
        <View style={this.setState.light_theme ? styles.containerLight : styles.container}>
          ...
          <View style={styles.appTitle}>
            ...
            <View style={styles.appTitleTextContainer}>
              <Text style={this.setState.light_theme ? styles.appTitleTextLight : styles.appTitleText}>Storytelling App</Text>
            </View>
          </View>
            ...
            <ScrollView style={this.setState.light_theme ? styles.story : styles.storyCard}>
              ...
              <View style={styles.dataContainer}>
                <View style={styles.titleTextContainer}>
                  <Text style={this.setState.light_theme ? styles.storyTitleTextLight : styles.storyTitleText}>
                    {this.props.route.params.story.title}
                  </Text>
                  <Text style={this.setState.light_theme ? styles.storyAuthorTextLight : styles.storyAuthorText}>
              ...
              <View style={styles.storyTextContainer}>
                <Text style={this.setState.light_theme ? storyTextLight : styles.storyText}>
                  {this.props.route.params.story.story}
                </Text>
                <Text style={this.setState.light_theme ? styles.moralTextLight : styles.moralText}>
                  Moral - {this.props.route.params.story.moral}
                </Text>
              </View>
              <View style={styles.actionContainer}>
              <TouchableOpacity onPress={() => {this.likeAction()}} style={this.state.is_liked?styles.likeButtonLiked:styles.likeButtonDisliked}>
